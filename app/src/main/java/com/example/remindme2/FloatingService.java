...
public class FloatingService extends Service {
    ...
    ArrayList<Note_Data> noteList=new ArrayList<>();
...
noteDataBaseSQL=new NoteDataBaseSQL(getApplicationContext());
...
//Set the close button
    ...
    for (int i=0;i<noteList.size();i++){
        ...
        myNotes.add(noteList.get(i).getContent());
    }

        //Toast.makeText(getApplicationContext(),"ID FROM FLOATING"+tripId,Toast.LENGTH_LONG).show();


        mBuilder = new NotificationCompat.Builder(this,"default");
        mBuilder.setContentText("Remind Me")
                .setContentTitle("You are currently on trip ")
                .setSmallIcon(R.drawable.circlecropped);
